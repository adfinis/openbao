...
dr-test-ha-fragmented-fanout-smoke:
	@./scripts/dr_local_test.sh --topology ha fragmented-fanout-smoke

dr-test-ha-reconcile-budget-smoke:
...
.PHONY: bin default prep test vet bootstrap fmt fmtcheck mysql-database-plugin mysql-legacy-database-plugin cassandra-database-plugin influxdb-database-plugin postgresql-database-plugin ember-dist ember-dist-dev static-dist static-dist-dev assetcheck check-openbao-in-path packages build build-ci semgrep semgrep-ci vet-godoctests ci-vet-godoctests dr-test-up dr-test-reset dr-test-status dr-test-smoke dr-test-verify dr-test-engine-matrix dr-test-preseed-smoke dr-test-failover-smoke dr-test-down dr-test-ha-reset dr-test-ha-status dr-test-ha-smoke dr-test-ha-verify dr-test-ha-engine-matrix dr-test-ha-engine-lifecycle-matrix dr-test-ha-failover-smoke dr-test-ha-promoted-durability-smoke dr-test-ha-reseed-secondary-smoke dr-test-ha-preseed-smoke dr-test-ha-transport-ca-rotation-smoke dr-test-ha-transport-ca-rotation-load-smoke dr-test-ha-transport-ca-rotation-chain-smoke dr-test-ha-indexed-repair-smoke dr-test-ha-fragmented-fanout-smoke dr-test-ha-reconcile-budget-smoke dr-test-ha-failover-load-lifecycle dr-test-ha-down
