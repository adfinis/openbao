...
func TestSystemBackend_RootPaths(t *testing.T) {
	expected := []string{
		...
		"replication/dr/primary/transport-ca/activate",
		"replication/dr/primary/transport-ca/retire-previous",
		"replication/dr/primary/transport-ca/stage",
		"replication/dr/primary/transport-ca/trust-bundle",
		...
		"replication/dr/secondary/transport-ca/accept",
